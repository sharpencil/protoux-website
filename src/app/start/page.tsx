        ...
        <main className="min-h-screen bg-slate-gray selection:bg-electric-cyan selection:text-authority-navy font-sans">
            ...
            <div className="container mx-auto px-6 py-32 lg:py-48 min-h-screen flex items-center justify-center">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start w-full max-w-7xl">
                    ...
                    >
                        <form data-netlify="true" name="start-form" method="POST" className="space-y-8">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input type="text" id="name" name="name" className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:border-electric-cyan focus:ring-1 focus:ring-electric-cyan outline-none transition-all text-authority-navy placeholder:text-slate-400" placeholder="Jane Doe" />
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="email" className="text-sm font-bold uppercase tracking-wide text-authority-navy/70">Work Email</label>
                                    <input type="email" id="email" name="email" className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:border-electric-cyan focus:ring-1 focus:ring-electric-cyan outline-none transition-all text-authority-navy placeholder:text-slate-400" placeholder="jane@company.com" />
                                </div>
                            </div>

                            <div className="space-y-2">
                                <label htmlFor="org" className="text-sm font-bold uppercase tracking-wide text-authority-navy/70">Organization / URL</label>
                                <input type="text" id="org" name="org" className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:border-electric-cyan focus:ring-1 focus:ring-electric-cyan outline-none transition-all text-authority-navy placeholder:text-slate-400" placeholder="Acme Corp / acme.com" />
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea id="challenge" name="challenge" rows={4} className="w-full px-4 py-3 rounded-xl bg-slate-50 border border-slate-200 focus:border-electric-cyan focus:ring-1 focus:ring-electric-cyan outline-none transition-all text-authority-navy placeholder:text-slate-400 resize-none" placeholder="Describe the problem, constraints, or goals..."></textarea>
                            </div>
                            ...
                            <button type="submit" className="w-full py-4 bg-electric-cyan text-authority-navy font-bold text-lg rounded-full shadow-lg shadow-electric-cyan/20 hover:shadow-electric-cyan/40 hover:-translate-y-1 transition-all duration-300 flex items-center justify-center gap-2 group">
                                Submit Brief
